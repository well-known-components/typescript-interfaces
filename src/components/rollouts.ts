...
export type IRolloutComponent = {
  isEnabled(
    name: string,
    context: IRolloutComponent.RolloutContext,
    fallbackFunction?: IRolloutComponent.FallbackFunction
  ): boolean
  getVariant(
    name: string,
    context: IRolloutComponent.RolloutContext,
    fallbackVariant?: IRolloutComponent.Variant
  ): IRolloutComponent.Variant
}
